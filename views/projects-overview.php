                                            ...
                                            <div class="row justify-content-between">
                                                <div class="col-sm-6 col-lg-6">
                                                    <form method="post">
                                                        ...
                                                        <input type="submit" name="details" class="button btn btn-primary btn-sm btn-responsive" name="detailsProject" value="Details" />
                                                    </form>
                                                </div>
                                                <div class="col-sm-6 col-lg-6">
                                                    <form action="./delete-project.php?id=<?= $project->id; ?>" method="post">
                                                        <input type="hidden" name="id" value="<?= $project->id; ?>" />
                                                        <input type="submit" class="button btn btn-danger btn-sm btn-responsive" name="deleteProject" value="Delete" />
                                                    </form>
                                                </div>
